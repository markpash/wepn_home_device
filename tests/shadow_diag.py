...
# under the License.
# Source: https://raw.githubusercontent.com/shadowsocks/shadowsocks-libev/master/tests/
# Keeping structure the same instead of making into Class to get future updates from source
